...
void fix_rotate::hough_transform(Mat& im, Mat& orig, double* skew)
{
...
Mat fix_rotate::preprocess1(Mat& im)
{
...
Mat fix_rotate::preprocess2(Mat& im)
{
...
Mat fix_rotate::rot(Mat& im, double thetaRad)
{
	cv::Mat rotated;
